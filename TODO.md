- добавить гугл аутентификацию
- исправить баг - обновляются даты создания транзакций в истории когда я добавляю задание сам или одобраю заявку ребенка в итоге лимиты на день сбиваются и история кривая - ты уже правил такой баг
- добавь еще один вид на выбр для отображения карточек заданий и товаров - строки- чтобы в строку компактно было видно основную информацию и было удобно скроллить на мобилке
