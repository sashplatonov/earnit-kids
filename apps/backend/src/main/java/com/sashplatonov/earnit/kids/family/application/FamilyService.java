...
public interface FamilyService extends FamilyPreferenceOperations {

  OperationResult<FamilyDashboardShellResponse> loadFamilyShellData(
      String familyId, Integer childId, boolean adminSession);

  OperationResult<FamilyDashboardDetailResponse> loadFamilyDetailData(
      String familyId, Integer childId, boolean adminSession);

  OperationResult<FamilyDataResponse> loadFamilyData(
      String familyId, Integer childId, boolean adminSession);

  OperationResult<FamilyDataResponse> saveFamilyData(
  ...
  OperationResult<Void> updateChildSettings(
      String familyId,
      int childId,
      String name,
      int dailyCoinLimit,
  ...
  OperationResult<Void> updateChildGroupOrder(
      String familyId,
      int childId,
  ...
  OperationResult<AnalyticsResponse> getAnalyticsData(
