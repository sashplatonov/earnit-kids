...
public class TelegramChildConnectionServiceImpl implements TelegramChildConnectionService {
    ...
    @Inject
    TelegramChildConnectionServiceImpl(FamilyRepository families, TelegramIdentityRepository identities,
                                       TelegramIdentityService identityService, TelegramConfig config,
                                       ChildOwnershipService childOwnershipService, TimeProvider timeProvider) {
