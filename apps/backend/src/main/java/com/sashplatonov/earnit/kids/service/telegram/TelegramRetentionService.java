...
public class TelegramRetentionService {
    ...
    @Inject TelegramChildInvitationRepository invitations;
    @Inject TelegramCallbackActionRepository callbacks;
    @Inject TelegramWebhookUpdateRepository webhookUpdates;
    @Inject TelegramDeliveryRepository deliveries;
    @Inject ApplicationOutboxEventRepository outboxEvents;
    @Inject TelegramSecurityAuditEventRepository auditEvents;
    @Inject TelegramConfig config;
