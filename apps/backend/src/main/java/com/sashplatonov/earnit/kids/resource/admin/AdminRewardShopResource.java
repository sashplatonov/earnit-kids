...
import com.sashplatonov.earnit.kids.service.admin.AdminRewardShopService;
...
public class AdminRewardShopResource {

    private final AdminRewardShopService rewardShopService;

    @Inject
    public AdminRewardShopResource(AdminRewardShopService rewardShopService) {
        this.rewardShopService = rewardShopService;
    }

    @GET
    @Path("/reward-shop")
    public Response getRewardShop(
        ...
        AdminRewardsResponse response = rewardShopService.getRewardShop(period);
