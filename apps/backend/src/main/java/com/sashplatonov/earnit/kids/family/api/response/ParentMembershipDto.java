...
public record ParentMembershipDto(
    ...
    @Schema(description = "Role of this membership in the pending admin-transfer request")
    String transferRequestRole
) {
    public ParentMembershipDto(
        ...
        FamilyParentMembershipEntity.Permission permission,
        MembershipStatus status) {
        this(id, email, null, null, null, null, permission, status, null, null, null, null, null, null);
    }
    ...
    public ParentMembershipDto(
        ...
        this(id, email, displayName, telegramUserId, telegramUsername, telegramDisplayName,
            permission, status, null, null, null, null, null, null);
    }
    ...
    public ParentMembershipDto(
        ...
        String invitationStatus) {
        this(id, email, displayName, telegramUserId, telegramUsername, telegramDisplayName,
            permission, status, invitationStatus, null, null, null, null, null);
    }
}
