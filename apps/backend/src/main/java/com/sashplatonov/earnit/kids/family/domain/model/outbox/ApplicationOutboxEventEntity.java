package com.sashplatonov.earnit.kids.family.domain.model.outbox;
...
public class ApplicationOutboxEventEntity {
  ...
  private ApplicationOutboxEventType eventType;
  ...
  private RequestResolutionStatus resolutionStatus;
  ...
  @Column(name = "planning_claimed_at")
  private Instant planningClaimedAt;

  @Column(name = "planning_completed_at")
  private Instant planningCompletedAt;
