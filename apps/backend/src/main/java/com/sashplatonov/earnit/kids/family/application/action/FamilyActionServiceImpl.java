...
public class FamilyActionServiceImpl implements FamilyActionService {
  ...
  @Inject
  public FamilyActionServiceImpl(
    ...
    FamilyActionSupportService supportService =
        new FamilyActionSupportService(
            familyRepository,
            childRepository,
            taskRepository,
            shopItemRepository,
            ...
            familyService);
    FamilyActionHistoryFactory historyFactory = new FamilyActionHistoryFactory(runtime.timeProvider());
    FamilyActionFrequencyService frequencyService =
        new FamilyActionFrequencyService(
            purchaseRequestRepository,
            historyRepository,
            familyRepository,
    ...
    this.balanceService =
        new FamilyActionBalanceService(
            supportService, historyFactory, historyRepository, runtime.eventPublisher());
    this.requestService =
        new FamilyActionRequestService(
            supportService,
            historyFactory,
            frequencyService,
            purchaseRequestRepository,
    ...
    this.importService =
        new FamilyActionImportService(
            supportService, frequencyService, taskRepository, shopItemRepository);
    this.backendKpiMetrics = backendKpiMetrics;
  }

  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> completeTask(
      String familyId, int childId, long taskId) {
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> requestTaskCompletion(
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> purchaseItem(
      String familyId, int childId, long itemId) {
    return backendKpiMetrics.recordResult(
        "family_action",
        "purchase_item",
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> requestItemPurchase(
      String familyId, int childId, long itemId, String note) {
    return backendKpiMetrics.recordResult(
        "family_action",
        "request_item_purchase",
        () -> requestService.requestItemPurchase(familyId, childId, itemId, note));
  }

  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> approveRequest(
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> rejectRequest(
      String familyId, Integer currentChildId, long requestId) {
    return backendKpiMetrics.recordResult(
        "family_action",
        "reject_request",
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> deleteRequest(
      String familyId, Integer currentChildId, long requestId) {
    return backendKpiMetrics.recordResult(
        "family_action",
        "delete_request",
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> deleteHistoryEntry(
      String familyId, int childId, long historyEntryId) {
    return backendKpiMetrics.recordResult(
        "family_action",
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> adjustBalance(
      String familyId, int childId, int amount, String description) {
    return backendKpiMetrics.recordResult(
        "family_action",
        "adjust_balance",
  ...
  @Override
  @Transactional
  public OperationResult<FamilyDataResponse> bulkTaskAction(
      String familyId, BulkTaskActionRequest request) {
    return backendKpiMetrics.recordResult(
        "family_action", "bulk_task_action", () -> bulkService.bulkTaskAction(familyId, request));
  }

  @Override
  @Transactional
  public FamilyDataResponse importTasks(String familyId, ImportTasksRequest request) {
    return backendKpiMetrics.recordValue(
        "family_action", "import_tasks", () -> importService.importTasks(familyId, request));
  }
