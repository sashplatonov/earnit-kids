package com.sashplatonov.earnit.kids.family.infrastructure.persistence.request;
...
public class PurchaseRequestRepository
    implements PanacheRepositoryBase<PurchaseRequestEntity, Long> {
  ...
  public void replaceRequests(int familyDbId, List<PurchaseRequestEntity> entries) {
    ...
    Map<Long, PurchaseRequestEntity> existingByExternalId =
