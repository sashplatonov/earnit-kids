...
final class FamilyRelatedDetailsResolver {

    private FamilyRelatedDetailsResolver() {
    }

    static HistoryDetails resolveHistoryDetails(HistoryEntryEntity entry,
    ...
    static RequestDetails resolveRequestDetails(PurchaseRequestEntity request,
                                                Map<Long, TaskDto> taskMap,
                                                Map<Long, ShopItemDto> shopMap,
                                                FamilyDashboardMapper mapper) {
