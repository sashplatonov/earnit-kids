...
@Tag(name = "Authentication", description = "Password recovery and email verification endpoints")
public class AuthRecoveryResource {

    private final AuthService authService;

    @Inject
    public AuthRecoveryResource(AuthService authService) {
