...
import com.sashplatonov.earnit.kids.admin.application.AdminChildBehaviorService;
...
public class AdminChildBehaviorResource extends ResourceAuthSupport {
    ...
    public Response getChildBehavior(
        ...
        try {
            AdminChildBehaviorResponse response = service.getChildBehavior(AdminAnalyticsPeriod.parse(period));
