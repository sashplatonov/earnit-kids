...
class TelegramAccountConnectionServiceImplTest {
    ...
    void startCreatesOpaqueExpiringChallengeForTheAuthenticatedParent() {
        ...
        var launch = ((OperationResult.Success<com.sashplatonov.earnit.kids.telegram.api.response.TelegramLinkLaunchResponse>) result)
            .value();
    ...
    void connectionDoesNotOfferTheMiniAppOutsideTheSelectedFamilysRollout() {
        ...
        OperationResult<com.sashplatonov.earnit.kids.telegram.api.response.TelegramAccountConnectionResponse> result =
