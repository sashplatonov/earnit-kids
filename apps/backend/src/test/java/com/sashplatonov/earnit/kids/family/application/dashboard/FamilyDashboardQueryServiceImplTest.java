...
class FamilyDashboardQueryServiceImplTest {
    ...
    void setUp() {
        ...
        FamilyDashboardHydrator hydrator = new FamilyDashboardHydrator(
            ...
            childRepository,
            mapper,
            new com.sashplatonov.earnit.kids.family.application.history.HistoryDtoMapper(mapper),
            new com.sashplatonov.earnit.kids.family.application.history.RelatedEntityHydrator(
