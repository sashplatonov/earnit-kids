...
class AdminAnalyticsRepositoryTest {
    ...
    @Inject AdminOverviewAnalyticsRepository adminOverviewAnalyticsRepository;
    @Inject AdminTaskAnalyticsRepository adminTaskAnalyticsRepository;
    @Inject AdminCoinEconomyRepository adminCoinEconomyRepository;
    @Inject AdminParentBehaviorRepository adminParentBehaviorRepository;
    @Inject AdminActivationAnalyticsRepository adminActivationAnalyticsRepository;
    @Inject AdminRewardAnalyticsRepository adminRewardAnalyticsRepository;
    ...
    void taskEconomyQueriesDoNotThrow() {
        ...
        assertThatCode(() -> adminTaskAnalyticsRepository.getTaskMetrics(Instant.EPOCH))
            .doesNotThrowAnyException();
        assertThatCode(() -> adminOverviewAnalyticsRepository.getOverview(Instant.EPOCH))
            .doesNotThrowAnyException();

        AdminTasksResponse.TaskMetrics taskMetrics = adminTaskAnalyticsRepository.getTaskMetrics(Instant.EPOCH);
        ...
        assertThatCode(() -> adminTaskAnalyticsRepository.calcTopTaskPatterns(Instant.EPOCH))
            .doesNotThrowAnyException();
    }
    ...
    void approvedTaskRequestDoesNotIncreaseRewardPurchaseCount() {
        ...
        int baseline = adminOverviewAnalyticsRepository.getOverview(periodStart).getRewardPurchases();
        ...
        int after = adminOverviewAnalyticsRepository.getOverview(periodStart).getRewardPurchases();
    ...
    void balanceMetricsDoNotThrowAndIncludeActiveChildren() {
        ...
        assertThatCode(() -> adminCoinEconomyRepository.getBalanceMetrics())
            .doesNotThrowAnyException();
    ...
    void familyJoinsUseCorrectFamilyDbIdAttribute() {
        ...
        assertThatCode(() -> adminParentBehaviorRepository.getParentBehaviorMetrics(Instant.EPOCH))
            .doesNotThrowAnyException();
        assertThatCode(() -> adminActivationAnalyticsRepository.getActivationFunnel(Instant.EPOCH))
            .doesNotThrowAnyException();
    }
    ...
    void activationFunnelUsesRegisteredFamilyCohort() {
        int baselineRegistered = adminActivationAnalyticsRepository.getActivationFunnel(Instant.EPOCH).get(0).getCount();
        int baselineWithChild = adminActivationAnalyticsRepository.getActivationFunnel(Instant.EPOCH).get(1).getCount();
        ...
        var allStages = adminActivationAnalyticsRepository.getActivationFunnel(Instant.EPOCH);
        var periodStages = adminActivationAnalyticsRepository.getActivationFunnel(periodStart);
    ...
    void rewardAnalyticsQueriesDoNotThrow() {
        ...
        Instant periodStart = Instant.EPOCH;
        assertThatCode(() -> adminRewardAnalyticsRepository.countAllRewardRequests(periodStart))
            .doesNotThrowAnyException();
        assertThatCode(() -> adminRewardAnalyticsRepository.calcMedianRewardPrice(periodStart))
            .doesNotThrowAnyException();
        assertThatCode(() -> adminRewardAnalyticsRepository.calcMedianPriceOfIssuedRewards(periodStart))
            .doesNotThrowAnyException();
        assertThatCode(() -> adminRewardAnalyticsRepository.calcRewardRankings(periodStart))
            .doesNotThrowAnyException();
        assertThatCode(() -> adminRewardAnalyticsRepository.countSuccessfulRewardPurchases(periodStart))
            .doesNotThrowAnyException();

        // EXPLAIN: Sanity — median prices are never negative.
        assertThat(adminRewardAnalyticsRepository.calcMedianRewardPrice(periodStart)).isNotNegative();
        assertThat(adminRewardAnalyticsRepository.calcMedianPriceOfIssuedRewards(periodStart)).isNotNegative();
    }
    ...
    void balanceMetricsExposeTimeToFirstReward() {
        ...
        AdminCoinEconomyResponse.BalanceMetrics metrics =
            adminCoinEconomyRepository.getBalanceMetrics();
