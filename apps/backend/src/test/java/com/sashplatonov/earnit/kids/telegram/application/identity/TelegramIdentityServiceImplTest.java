...
class TelegramIdentityServiceImplTest {
    ...
    void acceptInvitation_rejectsExpiredAndAlreadyLinkedIdentity() {
        var invitation = com.sashplatonov.earnit.kids.telegram.domain.model.TelegramChildInvitationEntity.builder()
    ...
    void mutationCallback_isSingleUseAndRejectsExpiredToken() {
        ...
        var callback = com.sashplatonov.earnit.kids.telegram.domain.model.TelegramCallbackActionEntity.builder()
    ...
    void mutationCallback_rejectsForeignIdentity() {
        ...
        verify(callbacks, never()).persist(any(com.sashplatonov.earnit.kids.telegram.domain.model.TelegramCallbackActionEntity.class));
    }
