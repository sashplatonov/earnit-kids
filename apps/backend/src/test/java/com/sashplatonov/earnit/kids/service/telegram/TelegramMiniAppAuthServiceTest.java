...
class TelegramMiniAppAuthServiceTest {
    ...
    void authenticatesLinkedParent() {
        ...
        var result = service(verifier, identities, families, children).authenticate("parent-data");
    ...
    void authenticatesLinkedChildOnlyWithinItsFamily() {
        ...
        var result = service(verifier, identities, families, children).authenticate("child-data");
    ...
    void rejectsIncompleteOrUnsupportedIdentityWithoutIssuingASession() {
        ...
        var result = service(verifier, identities, families, children).authenticate("bad-identity");
    ...
    private TelegramIdentityEntity identity(String role, Integer childId) {
        return TelegramIdentityEntity.builder().familyId(1).childId(childId).telegramUserId(77L).role(role).active(true).build();
    }
