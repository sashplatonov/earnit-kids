export const shopMessages = {
	...
	toasts: {
		...
		goalSaveFailed: 'Could not save the reward goal. Try again.',
	...
	goal: { label: 'Current reward goal', clear: 'Clear goal', stale: 'This reward goal is no longer available.', empty: 'No reward goal selected yet.', missing: '{amount} coins to go', ready: 'Ready to request' },
