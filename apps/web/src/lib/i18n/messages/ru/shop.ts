export const shopMessages = {
	...
	toasts: {
		...
		goalSaveFailed: 'Не удалось сохранить цель. Попробуйте ещё раз.',
	...
	goal: { label: 'Текущая цель-награда', clear: 'Сбросить цель', stale: 'Эта награда больше недоступна.', empty: 'Цель-награда пока не выбрана.', missing: 'Осталось {amount} монет', ready: 'Можно запросить' },
