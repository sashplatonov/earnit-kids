...
<style>
    .child-workspace { box-sizing:border-box; width:100%; max-width:48rem; min-height:100%; margin:0 auto; padding:calc(.75rem + env(safe-area-inset-top)) 1rem calc(2rem + env(safe-area-inset-bottom)); } .state { padding:2rem 1rem; color:#66718a; text-align:center; } button { min-height:2.75rem; margin-top:1rem; padding:.6rem .85rem; border:1px solid #3867d6; border-radius:.7rem; background:#3867d6; color:#fff; font:inherit; } .tabs { display:grid; grid-template-columns:repeat(2, 1fr); gap:.45rem; margin-bottom:.75rem; } .tabs button { margin-top:0; background:#fff; color:#33415f; } .tabs button.active { background:#3867d6; color:#fff; }
