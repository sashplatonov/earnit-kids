...
{#if open}
    ...
    <div class="sheet" role="dialog" aria-modal="true" aria-label={$i18n.t('app.telegram.parents.title')} tabindex="-1">
        {#if demoMode}
            ...
            <p class="demo-copy">{$i18n.t('app.liveDemo.mockSettingsHint')}</p>
