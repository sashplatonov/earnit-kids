...
<style>
    .panel { width:100%; }.section-heading { display:flex; justify-content:space-between; align-items:center; gap:.5rem; }.eyebrow { margin:0; color:#66718a; font-size:.75rem; text-transform:uppercase; letter-spacing:.08em; } h2 { margin:.15rem 0 .65rem; color:#18243d; }.items { display:grid; gap:.5rem; } article { display:flex; justify-content:space-between; gap:.75rem; align-items:center; width:100%; padding:.75rem; border:1px solid #e5e9f1; border-radius:.75rem; background:#fff; } h3 { margin:0; font-size:1rem; } p { margin:.25rem 0 0; color:#66718a; font-size:.875rem; } button { min-height:2.75rem; padding:.6rem .75rem; border:1px solid #dfe4ee; border-radius:.7rem; background:#fff; color:#33415f; font:inherit; cursor:pointer; }.actions { display:flex; gap:.35rem; }.approve { background:#e9f8ed; border-color:#8ed09b; }.reject { background:#fff0f0; border-color:#e0a0a0; }.error { color:#a33b3b; }.muted { color:#66718a; }
</style>
