...
<style>
    ...
    .check { width:2rem; height:2rem; flex:0 0 auto; align-self:center; display:grid; place-items:center; box-sizing:border-box; aspect-ratio:1/1; border:1px solid #cbd3e2; border-radius:.5rem; background:#fff; color:#17884b; font-weight:900; cursor:pointer; }
