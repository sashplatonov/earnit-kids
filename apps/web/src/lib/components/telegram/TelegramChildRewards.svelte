...
<section aria-labelledby="child-rewards-title">
    <div class="heading">
        ...
        <span class:goal-progress-label={nextGoal}>{nextGoal ? $i18n.t('app.telegram.childRewards.progress', { current: $appStore.balance, target: nextGoal.price }) : $i18n.t('app.telegram.childRewards.spendYourCoins')}</span>
    </div>
