...
<style>
    ...
    .switch { width:2.875rem; height:1.75rem; flex:0 0 auto; padding:0; border:0; border-radius:.5rem; background:#d8deea; cursor:pointer; position:relative; }
    .switch.on { background:#536be3; }
    .switch:after { content:""; position:absolute; width:1.25rem; height:1.25rem; top:.25rem; left:.25rem; border-radius:50%; background:#fff; box-shadow:0 1px 3px rgb(0 0 0 / 20%); transition:left .15s ease; }
    .switch.on:after { left:1.375rem; }
    .muted { color:#66718a; }
    .error { color:#a33b3b; }
