...
<style>
    ...
    :global(.entity-row .entity-title .title) { display:block; overflow:hidden; min-width:0; text-overflow:ellipsis; white-space:nowrap; color:#18243d; font-size:.8rem; font-weight:600; line-height:1.2; }
