...
<style>
    .catalog { display:grid; gap:.6rem; } article { display:flex; align-items:center; justify-content:space-between; gap:.75rem; padding:.8rem; border:1px solid #e1e6ef; border-radius:.8rem; background:#fff; } h3 { margin:0; color:#18243d; font-size:1rem; } p { margin:.25rem 0 0; color:#66718a; font-size:.875rem; } button { min-width:5.5rem; min-height:2.75rem; padding:.55rem .65rem; border:1px solid #3867d6; border-radius:.7rem; background:#3867d6; color:#fff; font:inherit; } button:disabled { border-color:#cfd6e4; background:#f1f3f7; color:#66718a; } .empty { padding:1.5rem 0; color:#66718a; text-align:center; } details { margin-bottom:.7rem; border:1px solid #e1e6ef; border-radius:.8rem; background:#fff; overflow:hidden; } summary { min-height:2.75rem; box-sizing:border-box; padding:.75rem .85rem; color:#18243d; font-weight:700; cursor:pointer; } details .catalog { padding:0 .6rem .6rem; }
</style>
