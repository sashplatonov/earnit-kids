...
<header class="public-site-header" aria-label={$i18n.t('common.navigation.publicAria')}>
    <a class="public-site-brand" href={$i18n.href('/')}>
    ...
    <a class="public-top-nav-cta" href={$i18n.href('/login')}>{$i18n.t('common.actions.login')} →</a>
</header>
