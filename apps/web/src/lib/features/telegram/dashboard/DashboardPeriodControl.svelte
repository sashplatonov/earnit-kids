...
<style>
    ...
    .seg { border: 0; background: transparent; color: #727b91; padding: 7px 4px; border-radius: 7px; font: inherit; font-size: 11px; font-weight: 700; cursor: pointer; min-height: 44px; }
