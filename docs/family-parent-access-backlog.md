...
| FPA-09 | 4 | P1 | FPA-05, FPA-07 | Add parent access management UI in Settings | ✅ **DONE**
| FPA-10 | 4 | P1 | FPA-06, FPA-09 | Add copy, i18n, UX polish, and empty/error states | ✅ **DONE**
| FPA-11 | 4 | P0 | all implementation tasks | Add regression tests and run release gates | ✅ **DONE**
