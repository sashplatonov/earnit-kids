...
Production rollout proof was provided by the operator before applying V55: CAT-DB-006 is deployed successfully and no running binary reads the V53 locale columns.
